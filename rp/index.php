...
<html>
  ...
  session_start();
   ?>
    <div class="container">
      <!--La navegación que se tiene dentro de la página-->
      ...
      <div id="contenedor"> </div><!--Este contenedor es donde se cargarán las páginas solicitadas-->

      <!--El script el cual hace el manejo de las llamadas de las página solicitadas-->
      <script type="text/javascript">
        $(document).ready(function () {
          ...
          /*Abre la página que mostrará los ajustes de los RP*/
          $("#btnAjustes").click(function(){
            $("#contenedor").load("ajustesRP.php");
          });
